...
// Register the Telemetry service as a singleton
...
app.MapGet("/important-business-value", (Telemetry telemetry) =>
{
    // Start the activity for distributed tracing
    using var activity = telemetry.ActivitySource.StartActivity("ImportantBusinessValueRetrieval");
